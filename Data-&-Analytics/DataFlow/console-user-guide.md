...
* サービスの有効化
    1. [プロジェクト管理](https://docs.toast.com/ko/TOAST/ko/console-guide/#_14)を参照してプロジェクトを作成します。
    2. プロジェクトを選択します。
    3. [プロジェクトサービス有効化ガイド](https://docs.toast.com/ko/TOAST/ko/console-guide/#_18)を参照してDataFlowを有効にします。
* フローの実行
...
フローを開始または停止する動作を制御します。

* 停止状態のフローを開始できます。
* 開始リクエストを伝えて実行準備中または実行中のフローを停止できます。
* 各フローは同時に1つのみ実行できます。
...
* チャート期間の選択
    * 期間の一括調整
        * ボタントグルにより、チャートの拡大/縮小動作をすべてのチャートに同期できます。
    * 現在時間
        * チャート期間を現在時間に設定します。
    * 期間の選択
